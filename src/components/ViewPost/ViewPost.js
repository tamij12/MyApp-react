    ...
    <div className="view-post  row col-lg-9">
        <div className="post">
          ...
          <div className="img-post">
            <div>
              <img className="image-post" src="https://th.bing.com/th/id/R.73f6012da281568c197dda051d92164a?rik=TCgCJVC%2blXcwtg&pid=ImgRaw&r=0" />
            </div>
          </div>
          <div className="description-post">
            <span>
              ...
              creative solutions, and a refreshing experience. In this article,
              we’ll unveil 20 remarkable mobile apps that have flown under the
              radar but are worth exploring. From productivity tools to
              innovative entertainment options, let’s discover these hidden
              gems!
            </span>
            <div>
              <p>AL Anany</p>
