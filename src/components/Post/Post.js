    ...
    <React.Fragment>
      <Link to={`/post/${_id}`} className="post">
        <div className="row">
          ...
          <div className="container-post row col-lg-6 shadow">
            <hr className="shadow hr-h"/>
            <div className="info-author-post d-flex">
              <div className="div-img-author-post">
                <div>
                  <img
            ...
            <div className="more-info-post d-flex">
              <div className="date-read d-flex">
                ...
                <div>
                  <span className="span">2 min read</span>
                </div>
              </div>
              <div>
                <button className="b">
            ...
            <div className="div-img-post">
              <div className="d-flex">
                <img className="img-post" src={img} />
              </div>
            </div>
            <hr  className="hr-h"/>
          </div>
